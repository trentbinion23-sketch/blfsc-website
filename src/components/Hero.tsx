  ...
  return (
    <section className="page-shell section-space">
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
        <div className="card-surface relative overflow-hidden border-[var(--line)] bg-[linear-gradient(135deg,rgba(7,14,26,0.98),rgba(5,12,22,0.94))] p-7 text-white sm:p-10 lg:p-12">
          <div className="absolute inset-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(45,109,246,0.26),transparent_38%),linear-gradient(135deg,rgba(4,9,20,0.9),rgba(7,14,26,0.7))]" />
          </div>
          <div className="relative max-w-2xl space-y-6">
            ...
            <p className="max-w-xl text-base leading-8 text-white/74 sm:text-lg">{description}</p>
